...
$(document).ready(function () {
    ...
    setInterval(function () {
        ...
        var hs = document.getElementById("hourText");
        var ms = document.getElementById("minuterText");
        var ss = document.getElementById("secondText");
        hs.innerHTML = hours < 10 ? '0' + hours : hours;
        ms.innerHTML = minutes < 10 ? '0' + minutes : minutes;
        ss.innerHTML = seconds < 10 ? '0' + seconds : seconds;
...
function clickinit() {
    $(".bigRedBtn").click(function () {
        var con = confirm("资质不符，请上传资质");
        if (con == true) {
            window.location.href = '/inframe/index.html?t=会员中心';
        } else {
