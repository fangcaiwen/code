...
function orderinfo(orderno){
    window.location.href="/orderform/buyerordershow.html?param="+orderno;
}
//签订合同
...
function viewCheckorder(orderNo){
    layer.open({
        ...
        maxmin: false, //开启最大化最小化按钮
        area: ['80%', '70%'],
        content: ['/orderform/checkorder/buyer_checkorder_view.html?v='+new Date().getTime(), 'yes'],
...
function payMoney(orderNo){
    ...
    topay("/pai/orderform/checkorder/payMoney.do",param);
}
