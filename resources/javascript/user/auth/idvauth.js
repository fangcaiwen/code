...
function submitComAuth(info){
	var reqdata=info;
	pairequest("/pai/memberAuth/individualAuth.do",reqdata).then(function(data){
...
function  showimg(userinfo,form){
	 ...
	 if(userinfo.getizhizhao!=undefined&&userinfo.getizhizhao!=""){
		 $("img[name='getizhizhao']").attr("src",userinfo.getizhizhao);
		  $($("img[name='getizhizhao']").siblings("i")).hide();
		  $("img[name='getizhizhao']").show();
	 }
